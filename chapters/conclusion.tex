...
After reading this tutorial it should be easy to quickly write great house automation applications and if that gets tiring, try sombrero(\url{http://grill.github.com/sombrero/}), a web interface to control EIB/KNX enabled houses. Sombrero is the first application to use Scalimero. 
